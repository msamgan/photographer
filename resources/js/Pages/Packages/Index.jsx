                        ...
                        {listings.map((listing, index) => {
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">{listing.services_count}</td>
                                    <td className="px-6 py-4">
                                        <EditLinkIcon link={route("package.edit", listing.uuid)}
                                                      lable={" Edit"}/>
                                        ...
                                        <DeleteLinkIcon link={route("package.destroy", listing.uuid)}
                                                        label={"Delete"}/>
                                    </td>
                                </tr>
                            )
