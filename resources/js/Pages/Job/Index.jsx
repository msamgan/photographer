                                            ...
                                            <span
                                                ...
                                                <ul>
                                                    {listing.events.map((event, index) => {
                                                            return (
                                                                <li key={index}>{event.event_name} on {event.event_date} at {event.event_time}</li>
                                                            )
                                                        }
                                                    )}
                                                </ul>
                                            </span>
                                            <span className={'text-blue-800 text-lg cursor-pointer'}>{listing.events.length}</span>
                                        </span>
                                    </td>
